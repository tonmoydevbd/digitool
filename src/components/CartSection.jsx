...
export const CartSection = (props) => {
  ...
  const cartProductEl = cartProduct.map(item => <div key={item.id} className="flex flex-col sm:flex-row gap-4 bg-gray-200 rounded-xl items-center p-4">
  ...
  return (
    <div className="max-w-300 mx-auto mt-10 p-4 sm:p-10 border border-gray-300 rounded-xl">
      ...
      {cartProduct.length === 0
        ...
        : <div className="my-6 flex flex-col gap-4 ">{cartProductEl}</div>}
